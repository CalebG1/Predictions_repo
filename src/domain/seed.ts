...
export const users: User[] = [
  { id: "u-risk", name: "R. Mensah (Risk Manager)", role: "risk_manager", team: "Risk" },
  { id: "u-exec", name: "D. Alvarez (CFO)", role: "executive", team: "Executive" },
  { id: "u-analyst", name: "K. Sato (Analyst)", role: "analyst", team: "Strategy" },
];
