...
export const evidenceSources: EvidenceSource[] = [
  {
    id: "ev-1",
    title: "Fed H.4.1 weekly release",
  ...
  {
    id: "ev-2",
    title: "BLS CPI report",
    url: "https://www.bls.gov/cpi/",
    sourceClass: "gov_stats",
    geographyTag: "US",
    methodTag: "official",
  ...
  },
  {
    ...
    url: "https://example.com/investor-relations/q2-transcript",
    sourceClass: "corporate_demand",
    methodTag: "primary",
  ...
  {
    id: "ev-6",
    title: "GDELT geopolitical event stream",
    url: "https://www.gdeltproject.org/",
    sourceClass: "fast_feed",
    methodTag: "entity-extraction",
  ...
  {
    id: "ev-7",
    title: "Internal incident log (SecOps)",
  ...
  {
    id: "ev-8",
    title: "Opposing think-tank brief",
    url: "https://example.com/research/opposing-view-brief",
    sourceClass: "fast_feed",
    ideologyTag: "contrarian",
...
const Q: QSeed[] = [
  {
    ...
    preciseDefinition:
      "A SEV-1/SEV-2 incident with confirmed data exfiltration of customer PII, disclosed internally, before 2026-10-01.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "$8–20M remediation + disclosure",
    impactLevel: "critical",
    impactScore: 0.9,
    resolutionCriteria:
      "Resolves YES if SecOps confirms exfiltration of customer PII in a SEV-1/2 incident.",
    resolutionSource: "SecOps incident review board",
    openDate: "2026-04-01",
  ...
  },
  {
    ...
    preciseDefinition:
      "A ransomware attack causes production system encryption or material business disruption before 2026-09-30.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "$5–15M downtime + recovery",
    impactLevel: "critical",
    impactScore: 0.88,
    resolutionCriteria:
      "Resolves YES if SecOps confirms ransomware encryption of production systems.",
    resolutionSource: "SecOps incident review board",
    openDate: "2026-04-15",
  ...
  },
  {
    ...
    preciseDefinition:
      "Business email compromise results in unauthorized wire transfer exceeding $500K before 2026-12-31.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "$500K–$2M direct loss",
    impactLevel: "high",
    impactScore: 0.72,
    resolutionCriteria: "Resolves YES if Treasury confirms unauthorized wire >$500K from BEC.",
    resolutionSource: "Treasury fraud report",
    openDate: "2026-03-01",
  ...
  },
  {
    ...
    preciseDefinition:
      "A top-10 vendor with access to our customer or employee data reports a breach affecting our data before 2026-12-31.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "$3–10M notification + legal",
    impactLevel: "high",
    impactScore: 0.82,
    resolutionCriteria: "Resolves YES on vendor breach notification confirming our data exposure.",
    resolutionSource: "Third-party risk register",
    openDate: "2026-02-01",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "leadership",
  ...
  },
  {
    ...
    preciseDefinition:
      "Confirmed compromise of a domain admin or cloud root-equivalent account before 2026-09-30.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "Full environment takeover risk",
    impactLevel: "critical",
    impactScore: 0.86,
    resolutionCriteria: "Resolves YES if IAM team confirms privileged credential compromise.",
    resolutionSource: "IAM incident log",
    openDate: "2026-04-01",
    resolutionDate: "2026-09-30",
    status: "open",
    visibility: "team",
  ...
  },
  {
    ...
    preciseDefinition:
      "A publicly exposed cloud resource (S3, storage account, or API) is exploited before 2026-12-31.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "$2–8M remediation + audit findings",
    impactLevel: "high",
    impactScore: 0.7,
    resolutionCriteria:
      "Resolves YES on confirmed exploitation of a critical cloud misconfiguration.",
    resolutionSource: "Cloud security posture dashboard",
    openDate: "2026-03-15",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "team",
  ...
  },
  {
    ...
    preciseDefinition:
      "A DDoS attack causes customer-facing service unavailability exceeding 4 consecutive hours before 2026-12-31.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "SLA credits + reputational damage",
    impactLevel: "medium",
    impactScore: 0.55,
    resolutionCriteria: "Resolves YES if SRE confirms >4hr customer-facing outage from DDoS.",
    resolutionSource: "SRE incident log",
    openDate: "2026-01-01",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "public",
  ...
  },
  {
    ...
    preciseDefinition:
      "Organization fails to complete SOC 2 Type II audit within the committed 2026-08-31 window.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "Enterprise deal delays + $1.5M pipeline risk",
    impactLevel: "high",
    impactScore: 0.65,
    resolutionCriteria: "Resolves YES if audit firm confirms window miss.",
    resolutionSource: "GRC audit tracker",
    openDate: "2026-02-01",
  ...
  },
  {
    ...
    preciseDefinition:
      "A CVSS ≥9.0 vulnerability with available patch is exploited in our environment before patch deployment.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "$1–5M incident response",
    impactLevel: "high",
    impactScore: 0.74,
    resolutionCriteria:
      "Resolves YES if SecOps confirms exploitation of an unpatched critical CVE.",
    resolutionSource: "Vulnerability management dashboard",
    openDate: "2026-04-01",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "team",
  ...
  },
  {
    ...
    preciseDefinition:
      "Phase 2 zero trust architecture (identity-aware proxy + device trust) deployed to all production workloads by 2026-10-01.",
    category: "Security/Cyber",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Reduces lateral movement risk; enables insurance renewal",
    impactLevel: "high",
    impactScore: 0.6,
    resolutionCriteria: "Resolves YES if CISO confirms Phase 2 deployment complete.",
    resolutionSource: "Security program tracker",
    openDate: "2026-01-15",
    resolutionDate: "2026-10-01",
    status: "open",
    visibility: "public",
  ...
  },
  {
    ...
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "~$30M revenue at risk / line-down",
    impactLevel: "high",
    impactScore: 0.78,
    resolutionCriteria: "Resolves YES on a >14-day shipment halt confirmed by Procurement.",
    resolutionSource: "Procurement ops dashboard",
    openDate: "2026-03-15",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "public",
  ...
  },
  {
    ...
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Lowers refinancing cost on $400M revolver",
    impactLevel: "high",
    impactScore: 0.6,
  ...
  },
  {
    ...
    preciseDefinition:
      "v3 platform reaches general availability on or before the committed 2026-11-15 date.",
    category: "Product",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "$45M ARR pipeline unlock",
    impactLevel: "high",
    impactScore: 0.72,
    resolutionCriteria: "Resolves YES if GA flag is enabled in prod by 2026-11-15.",
    resolutionSource: "Release management",
    openDate: "2026-04-10",
  ...
  },
  {
    ...
    title: "Atlas EV battery enclosure passes alpha side-impact test on first attempt",
    preciseDefinition:
      "The Atlas EV alpha battery enclosure completes the planned side-impact test without a containment breach or a design change that delays the beta build, by 2026-09-18.",
    category: "Product",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Protects the beta build and 2028 model-year launch plan",
    impactLevel: "high",
    impactScore: 0.76,
    resolutionCriteria:
      "Resolves YES when the certified side-impact test report is approved without a required enclosure redesign.",
    resolutionSource: "Atlas validation evidence index",
    openDate: "2026-07-01",
    resolutionDate: "2026-09-18",
    status: "open",
    visibility: "public",
  ...
  },
  {
    ...
    title: "Atlas EV alpha crash-test article is ready by September 8",
    preciseDefinition:
      "All battery enclosure components and fixtures for the Atlas alpha crash-test article are released, built, and accepted by the validation lab on or before 2026-09-08.",
    category: "Supply Chain",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Avoids a 2–3 week slip to alpha crash testing",
    impactLevel: "high",
    impactScore: 0.72,
    resolutionCriteria:
      "Resolves YES on validation-lab acceptance of the completed test article by September 8.",
    resolutionSource: "Atlas program hub and supplier readiness dashboard",
    openDate: "2026-07-01",
  ...
  },
  {
    ...
    title: "Atlas EV battery enclosure requires material rework after thermal validation",
    preciseDefinition:
      "Thermal validation produces a result that requires a material or geometry change to the Atlas battery enclosure before alpha crash testing begins.",
    category: "Operational",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "Potential 2–3 week validation slip and prototype rebuild cost",
    impactLevel: "high",
    impactScore: 0.7,
    resolutionCriteria:
      "Resolves YES if the design review records a required material or geometry revision due to thermal validation findings.",
    resolutionSource: "Atlas thermal validation review",
    openDate: "2026-07-15",
  ...
  },
  {
    ...
    title: "Atlas EV cell supplier confirms Q4 capacity allocation by August 28",
    preciseDefinition:
      "The selected cell supplier provides a signed allocation confirmation covering the Atlas EV beta-build demand by 2026-08-28.",
    category: "Supply Chain",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Secures beta-build materials and protects prototype timing",
    impactLevel: "high",
    impactScore: 0.73,
    resolutionCriteria:
      "Resolves YES on receipt of a signed supplier allocation confirmation accepted by Atlas procurement.",
    resolutionSource: "Supplier readiness dashboard",
    openDate: "2026-07-20",
  ...
  },
  {
    ...
    title: "Atlas EV beta vehicle build begins by November 6",
    preciseDefinition:
      "The first Atlas EV beta vehicle enters the planned build station on or before 2026-11-06 with the production-intent battery enclosure installed.",
    category: "Product",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Protects 2028 model-year launch timing and validation sequence",
    impactLevel: "critical",
    impactScore: 0.86,
    resolutionCriteria:
      "Resolves YES when manufacturing records confirm the first beta vehicle started build with the production-intent enclosure.",
    resolutionSource: "Atlas master schedule",
    openDate: "2026-07-01",
  ...
  },
  {
    ...
    title: "Atlas EV battery supplier delivery delay exceeds 10 business days before beta build",
    preciseDefinition:
      "The selected Atlas EV battery supplier misses any committed component delivery by more than 10 business days before the beta build begins.",
    category: "Supply Chain",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "May delay beta build and require alternative sourcing",
    impactLevel: "high",
    impactScore: 0.75,
    resolutionCriteria:
      "Resolves YES on procurement confirmation of a committed delivery delay exceeding 10 business days.",
    resolutionSource: "Supplier readiness dashboard",
    openDate: "2026-07-20",
    resolutionDate: "2026-11-06",
    status: "open",
  ...
  },
  {
    ...
    preciseDefinition:
      "Rolling 12-month voluntary engineering attrition crosses 15% before 2026-12-31.",
    category: "Talent",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "Roadmap slip + ~$6M backfill cost",
    impactLevel: "medium",
    impactScore: 0.5,
    resolutionCriteria: "Resolves YES if HRIS rolling attrition > 15%.",
    resolutionSource: "People analytics (HRIS)",
    openDate: "2026-02-01",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "team",
  ...
  },
  {
    ...
    preciseDefinition:
      "EU adopts binding data-localization requirements affecting our EU operations before 2027-03-31.",
    category: "Regulatory",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "€12M infra + compliance build",
    impactLevel: "high",
    impactScore: 0.68,
  ...
  },
  {
    ...
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "FX translation drag on EU revenue",
    impactLevel: "medium",
    impactScore: 0.45,
  ...
  },
  {
    ...
    preciseDefinition:
      "A major lane (Red Sea / Hormuz / Panama) remains materially disrupted on 2026-10-01.",
    category: "Geopolitical",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "+18% freight + 2-week lead times",
    impactLevel: "high",
    impactScore: 0.66,
    resolutionCriteria: "Resolves YES if Drewry/IMF flags the lane as disrupted on 2026-10-01.",
    resolutionSource: "Drewry / IMF PortWatch",
    openDate: "2026-04-01",
    resolutionDate: "2026-10-01",
    status: "open",
    visibility: "public",
  ...
  },
  {
    ...
    preciseDefinition:
      "A reputational event drives a ≥10pt NPS drop within 30 days before 2026-12-31.",
    category: "Reputational",
    type: "binary",
    riskOrOpportunity: "risk",
    impactEstimate: "Churn + CAC headwind",
    impactLevel: "medium",
    impactScore: 0.5,
    resolutionCriteria:
      "Resolves YES on a confirmed ≥10pt NPS drop attributable to a single event.",
    resolutionSource: "Brand tracker",
    openDate: "2026-03-01",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "public",
  ...
  },
  {
    ...
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Beats guidance; multiple re-rate",
    impactLevel: "medium",
    impactScore: 0.55,
    resolutionCriteria: "Resolves YES if reported Q3 GM ≥ 64.0%.",
    resolutionSource: "Q3 financial statements",
    openDate: "2026-05-01",
  ...
  },
  {
    ...
    preciseDefinition:
      "Definitive agreement signed and closed for the named target before 2026-12-31.",
    category: "Financial",
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "+$120M revenue, integration risk",
    impactLevel: "critical",
    impactScore: 0.85,
  ...
  },
  {
    ...
    scalarUnit: "% YoY",
    riskOrOpportunity: "risk",
    impactEstimate: "Rates path / discount rate",
    impactLevel: "medium",
    impactScore: 0.4,
  ...
  },
  {
    ...
    type: "binary",
    riskOrOpportunity: "opportunity",
    impactEstimate: "Avoids SLA credits + churn",
    impactLevel: "medium",
    impactScore: 0.5,
    resolutionCriteria: "Resolves YES if SRE availability ≥ 99.95%.",
    resolutionSource: "SRE availability report",
    openDate: "2026-01-01",
    resolutionDate: "2026-12-31",
    status: "open",
    visibility: "public",
...
export const resolutions: Resolution[] = [
  {
    id: "res-1",
    questionId: "q-past-audit",
    resolvedValue: 1,
    brierContribution: 0.04,
    errorType: "underreaction",
    lessonsLearned:
      "Underweighted regulator's prior enforcement pattern; raise base rate for repeat audits.",
    resolvedAt: "2026-05-30",
  },
  {
    id: "res-2",
    questionId: "q-past-outage",
    resolvedValue: 0,
    brierContribution: 0.09,
    errorType: "overreaction",
    lessonsLearned:
      "Overreacted to a single noisy incident signal; require 2 corroborating signals before sharp moves.",
